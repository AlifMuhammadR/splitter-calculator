...
<div id="sidebar" class="position-fixed sidebar-hidden">
    <div class="inner p-3">
        ...
        <div class="d-grid gap-2 mb-2">
            <button class="btn btn-sm" style="background: linear-gradient(87deg, #2d93ce 0, #107abc 100%); border: none;" onclick="exportTopology()">⬇ Export (.json)</button>
...
<script>
                        ...
                        el.querySelector('.btn-delete-node').onclick = (e) => {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    jsPlumb.deleteEveryEndpoint(el);
                                    jsPlumb.remove(el);
    ...
    `;
                    ...
                    window.gatherAndSaveTopology = async function() {
                        ...
                        try {
                            const res = await fetch(`/lab/${labId}/update-json`, {
                                method: 'POST',
                                headers: {
